...
# How do you explain the result for tricky? Since one of the elements of tricky is of type character (the fourth), the type of the vector becomes character despite the numeric elements preceding.
```
...
Character has a higher order than numeric which has a higher order than logical. 

# Question 3
```{r}
# Build a vector of the study semesters (Winter2015  through Winter2020): 

study_sem <- c("Winter2015", "Fall2015", "Winter2016", "Fall2016", "Winter2017", "Fall2017", "Winter2018", "Fall2018", "Winter2019", "Fall2019", "Winter2020")

# Build a vector of the supplements consumed (see powerpoint slides): 
supp_cons <- c("BRMPS", "HiMaize260", "inulin", "arabinoxylan", "psyllium","accessible corn starch", "resistant banana starch", "transition on HiMaize260/switch to BRMPS" , "LOODAAT potato starch", "oat", "rice")

# What type are each of these?  each are of type character
```

# Question 4
```{r}
# Build a vector of the typical age of college students:
age_college <- c(17,18,19,20,21,22,23)

# Confirm this is numeric
is.numeric(age_college)
# Convert this vector to character:
age_college <- as.character(age_college)
...
avg_pH1 <- round(mean(as.numeric(pH_1)), 2)

avg_pH1

pH_2 <- c("8", "7.25", "7.25", "7.75", "7.5", "7.25")

avg_pH2 <- round(mean(as.numeric(pH_2)), 2)
